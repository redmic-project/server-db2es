...
public class SpeciesWithValidAsProcessor implements ItemProcessor<AbstractSpecies, es.redmic.models.es.administrative.taxonomy.model.Species> {
	 
	private static final Logger LOGGER = LoggerFactory.getLogger(SpeciesWithValidAsProcessor.class);
