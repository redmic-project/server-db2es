...
public class OrderDiscardValidAsProcessor implements ItemProcessor<Orderr, Taxon> {
	 
	private static final Logger LOGGER = LoggerFactory.getLogger(OrderDiscardValidAsProcessor.class);
