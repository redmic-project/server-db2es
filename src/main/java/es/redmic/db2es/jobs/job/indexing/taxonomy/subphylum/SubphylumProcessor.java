...
public class SubphylumProcessor implements ItemProcessor<Subfilum, Taxon> {
	...
	@Autowired
	private SubfilumESService service;

	public Taxon process(Subfilum inBean) throws Exception {
